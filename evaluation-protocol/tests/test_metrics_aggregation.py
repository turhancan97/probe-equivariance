...
class MetricsAggregationTests(unittest.TestCase):
    def setUp(self):
        ...
        self._write_result("parallel_clip_large", "clip_large_laion", "01082026-1001", 0.1)
        self._write_result("parallel_dinov2_small", "dinov2_vits14", "01082026-1002", 0.3)
        self._write_result(
    ...
    def test_aggregate_and_plot(self):
        ...
        values = _group_values(combined_rows, ["val_rmse", "test_rmse"])
